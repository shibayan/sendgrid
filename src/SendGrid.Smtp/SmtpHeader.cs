...
namespace SendGrid.Smtp
{
    public sealed class SmtpHeader
    {
        ...
        private readonly Dictionary<string, IEnumerable<string>> _substitutions = new Dictionary<string, IEnumerable<string>>();
        ...
        public void AddSendAt(IEnumerable<DateTimeOffset> dateTimes)
        {
            _sendAt.AddRange(dateTimes);
        }
        ...
        public void AddCategory(IEnumerable<string> categories)
        {
            _categories.AddRange(categories);
        }
        ...
        public override string ToString()
        {
            ...
            if (_sendAt.Count != 0)
            {
                ...
                {
                    data.Add("send_each_at", _sendAt.Select(x => (long)(x.UtcDateTime - _unixEpoch).TotalSeconds).ToArray());
                }
            }
